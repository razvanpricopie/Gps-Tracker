...
public class UserServiceImpl implements UserService {
    ...
    public User register(UserRegisterDTO userRegisterDTO) throws BusinessException {
        ...
        if(Objects.isNull(userRegisterDTO.getLastName())){
            throw new BusinessException(400,"Last name doesn't be null!");
        }
        ...
        if(!userRegisterDTO.getPassword().equals(userRegisterDTO.getConfirmPassword())){
            throw new BusinessException(402,"Passwords don't match!");
        }

        if(Objects.nonNull(userRepository.findByEmail(userRegisterDTO.getEmail()))){
            throw new BusinessException(402,"This email already exist!");
        }
